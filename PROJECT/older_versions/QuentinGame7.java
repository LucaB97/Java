...
public class QuentinGame {
    ...
    public static class quentin {
        ...
        public boolean gameover() {
            ...
            HashSet<Integer> winning_path = new HashSet<>();
            ...
            if (black_won || white_won) {
                System.out.println(black_won ? "BLACK WON!" : "WHITE WON!");
                System.out.println(winning_path);
            }

            return !winning_path.isEmpty();
        }

        public boolean winning_path_lookup(final int idx, ArrayList<Integer> exclude , HashSet<Integer> winning_path) {
