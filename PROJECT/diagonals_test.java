...
public class diagonals_test {
    ...
    public void diagonals_test_topleft() {
        ...
        assertEquals(new ArrayList<>(Arrays.asList(6)), myboard.diagonals(0));
    }

    @Test
    public void diagonals_test_topright() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(8)), myboard.diagonals(4));
    }

    @Test
    public void diagonals_test_bottomleft() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(16)), myboard.diagonals(20));
    }

    @Test
    public void diagonals_test_bottomright() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(18)), myboard.diagonals(24));
    }

    @Test
    public void diagonals_test_upperedge() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(7,9)), myboard.diagonals(3));
    }

    @Test
    public void diagonals_test_loweredge() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(16,18)), myboard.diagonals(22));
    }

    @Test
    public void diagonals_test_leftedge() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(6,16)), myboard.diagonals(10));
    }

    @Test
    public void diagonals_test_rightedge() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(3,13)), myboard.diagonals(9));
    }

    @Test
    public void diagonals_test_center() {
        quentin myboard = new quentin(5);
        assertEquals(new ArrayList<>(Arrays.asList(5,7,15,17)), myboard.diagonals(11));
    }
