...
public class QuentinGame {
    ...
    public static class quentin {
        ...
        public void update_board(final boolean black) {
            ...
            while (true) {
                ...
                while (!empty_locations.isEmpty()) {
                    ...
                    System.out.println("I am a region: " + region);
                    if (candidate_for_territory(region)) {
                        System.out.println("New territory found:" + region);
        ...
        public boolean adiacent_location(final ArrayList<Integer> region, final int idx) {
